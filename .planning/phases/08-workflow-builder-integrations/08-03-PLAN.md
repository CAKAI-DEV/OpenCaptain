...
must_haves:
  ...
  key_links:
    - from: "src/features/insights/insights.service.ts"
      ...
      pattern: "getOutputMetrics|getVelocity"
      verify_exports: ["getOutputMetrics", "getVelocity"]
...
<task type="auto">
  ...
  <action>
    ...
    2. Create `src/features/insights/insights.service.ts`:
       - First verify metrics.service.ts exports: getOutputMetrics, getVelocity (check with grep)
       - Import getOutputMetrics, getVelocity from metrics.service
